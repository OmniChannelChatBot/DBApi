...
namespace DB.Infrastructure.Data.Migrations
{
    ...
    [Migration("20200225124928_MessangerEntity")]
    partial class MessangerEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DB.Core.Entities.Company.CompanyEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DB.Core.Entities.Messangers.MessangerEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DB.Core.Entities.Identity.UserEntity", b =>
                {
                    b.HasOne("DB.Core.Entities.Company.CompanyEntity", null)
            ...
            modelBuilder.Entity("DB.Core.Entities.Messangers.MessangerEntity", b =>
                {
                    b.HasOne("DB.Core.Entities.Company.CompanyEntity", "Company")
                        .WithMany()
